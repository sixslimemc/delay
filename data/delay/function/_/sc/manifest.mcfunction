...
data modify storage slimecore:in manifest.pack.pack_id set value "delay"
...
data modify storage slimecore:in manifest.pack.display.name set value "Delay"
...
data modify storage slimecore:in manifest.pack.display.links.info set value "https://github.com/sixslimemc/delay"
