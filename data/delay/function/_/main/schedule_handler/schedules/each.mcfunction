...
execute if score *schedule.ticks _delay matches 1.. run execute store result storage delay:_ t.schedule.ticks int 1 run scoreboard players get *schedule.ticks _delay
execute if score *schedule.ticks _delay matches 1.. run function delay:_/main/schedule_handler/schedules/scheduled with storage delay:_ t.schedule
